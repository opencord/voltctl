...
const (
  ...
  CONNECTSTATUS: {{.ConnectStatus}}`
	...
	DEFAULT_DEVICE_UPDATES_FORMAT               = "table{{.Timestamp}}\t{{.Operation}}\t{{.OperationID}}\t{{.RequestedBy}}\t{{.StateChange}}\t{{.Status}}"
	DEFAULT_DEVICE_UPDATES_FORMAT_WIDE          = "table{{.Timestamp}}\t{{.Operation}}\t{{.OperationID}}\t{{.RequestedBy}}\t{{.StateChange}}\t{{.Status}}\t{{.Description}}"
)

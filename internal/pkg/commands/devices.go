...
const (
  ...
  CONNECTSTATUS: {{.ConnectStatus}}`
	...
	DEFAULT_DEVICE_REASON_FORMAT                = "table{{.DeviceID}}\t{{.Reason}}"
)
...
type DeviceOpts struct {
	...
	Reasons DeviceReasonList `command:"reasons"`

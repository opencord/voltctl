...
/* InterContainerHeader is a set of fields extracted
 * from voltha.InterContainerHeader as well as useful other
...
func DecodeInterContainerHeader(icFile *desc.FileDescriptor, md *desc.MessageDescriptor, b []byte, ts time.Time, f grpcurl.Formatter) (*InterContainerHeader, error) {
	...
	icHeader := InterContainerHeader{Id: id,

...
var (
	...
	GlobalOptions struct {
		...
		Timeout        string `short:"t" long:"timeout" description:"API call timeout duraction" value-name:"DURACTION" default:""`
...
func ProcessGlobalOptions() {
	...
	if GlobalOptions.Timeout != "" {
		...
		if err != nil {
			Error.Fatalf("Unable to parse specified timeout diraction '%s': %s",
